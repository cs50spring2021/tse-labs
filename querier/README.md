...
*Before you begin*, make sure you submitted Lab 5 correctly, [as instructed](https://www.cs.dartmouth.edu/~cs50/Labs/submit.html).
...
See the [Lab submission instructions](https://www.cs.dartmouth.edu/~cs50/Labs/submit.html).
